          ...
          <div class="relative flex flex-col lg:flex-row items-center gap-8">
            ...
            <div class="text-center lg:text-left flex-1 space-y-4">
              <div>
                ...
                <p class="text-blue-100 text-lg font-medium mb-4">
              ...
              <div class="flex justify-center lg:justify-start">
                <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-sm border border-white/20 transition-all duration-300 hover:bg-white/10"
        ...
        <div class="p-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl p-6 border border-slate-200/50 hover:shadow-lg transition-all duration-300">
              ...
              <div class="space-y-4">
                <div class="flex justify-between items-center py-3 px-4 bg-white rounded-lg border border-slate-200/50 hover:border-blue-200 transition-colors">
                  ...
                  <span class="text-slate-800 font-semibold">
                    {{ userStore.userProfile?.user?.date_of_birth ? new Date(userStore.userProfile.user.date_of_birth).toLocaleDateString() : 'Not provided' }}
                  </span>
                </div>
