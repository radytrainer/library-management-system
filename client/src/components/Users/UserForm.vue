...
<template>
  <div v-if="show"
    ...
    <div
      class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl h-[85vh] flex flex-col transform transition-all duration-300 scale-100 animate-in slide-in-from-bottom-4">
        ...
        <form @submit.prevent="submitForm" class="h-full flex flex-col">
              ...
              <div class="w-full max-w-xs">
                ...
                <div class="relative group mb-4">
                  <div
                    ...
                    <img v-if="localForm.profile_image_preview" :src="localForm.profile_image_preview"
                      alt="Profile Preview"
          ...
          <div class="flex-shrink-0 flex justify-end gap-4 pt-6 border-t border-gray-200 mt-6">
            ...
            <button type="submit"
              ...
              <svg v-if="userStore.loading" class="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24">
